"""
Example: How to call the racenet-au-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/racenet-au-scraper
...
def run_actor():
    """Run the racenet-au-scraper actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/racenet-au-scraper"
    print(f"Starting actor: {actor_id}")

    run = client.actor(actor_id).call(
        run_input={
            "startUrls": [{"url":"https://www.racenet.com.au/profiles/horse/briasa-aus"}],
